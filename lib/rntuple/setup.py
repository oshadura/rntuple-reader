...
https://github.com/pypa/rntuple-reader
"""
...
setup(
    ...
    #
    # $ pip install rntuple-reader
    #
    # And where it will live on PyPI: https://pypi.org/project/rntuple-reader/
    #
    ...
    # syntax, for example:
    #
    #   $ pip install rntuple-reader[dev]
    #
